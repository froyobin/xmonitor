...
github.com/openstack/rally/tree/master/samples/tasks/scenarios/xmonitor
...
class GlancePlugin(scenario.OpenStackScenario):
    ...
    @atomic.action_timer("xmonitor.create_image_label")
    def _create_image(self, image_name, container_format,
        ...
        try:
            ...
            image = self.clients("xmonitor").images.create(**kw)
    ...
    @atomic.action_timer("xmonitor.list_images_label")
    def _list_images(self):
        return list(self.clients("xmonitor").images.list())

    @scenario.configure(context={"cleanup": ["xmonitor"]})
