...
class Enforcer(policy.Enforcer):
    ...
    def enforce(self, context, action, target):
        """Verifies that the action is valid on the target in this context.
           ...
           :raises: `xmonitor.common.exception.Forbidden`
...
class ImageRepoProxy(xmonitor.domain.proxy.Repo):
...
class ImageProxy(xmonitor.domain.proxy.Image):
...
class ImageMemberProxy(xmonitor.domain.proxy.ImageMember):
...
class ImageFactoryProxy(xmonitor.domain.proxy.ImageFactory):
...
class ImageMemberFactoryProxy(xmonitor.domain.proxy.ImageMembershipFactory):
...
class ImageMemberRepoProxy(xmonitor.domain.proxy.Repo):
...
class TaskProxy(xmonitor.domain.proxy.Task):
...
class TaskStubProxy(xmonitor.domain.proxy.TaskStub):
...
class TaskRepoProxy(xmonitor.domain.proxy.TaskRepo):
...
class TaskStubRepoProxy(xmonitor.domain.proxy.TaskStubRepo):
...
class TaskFactoryProxy(xmonitor.domain.proxy.TaskFactory):
...
class MetadefNamespaceProxy(xmonitor.domain.proxy.MetadefNamespace):
...
class MetadefNamespaceRepoProxy(xmonitor.domain.proxy.MetadefNamespaceRepo):
...
class MetadefNamespaceFactoryProxy(
        xmonitor.domain.proxy.MetadefNamespaceFactory):
...
class MetadefObjectProxy(xmonitor.domain.proxy.MetadefObject):
...
class MetadefObjectRepoProxy(xmonitor.domain.proxy.MetadefObjectRepo):
...
class MetadefObjectFactoryProxy(xmonitor.domain.proxy.MetadefObjectFactory):
...
class MetadefResourceTypeProxy(xmonitor.domain.proxy.MetadefResourceType):
...
class MetadefResourceTypeRepoProxy(
        xmonitor.domain.proxy.MetadefResourceTypeRepo):
...
class MetadefResourceTypeFactoryProxy(
        xmonitor.domain.proxy.MetadefResourceTypeFactory):
...
class MetadefPropertyProxy(xmonitor.domain.proxy.MetadefProperty):
...
class MetadefPropertyRepoProxy(xmonitor.domain.proxy.MetadefPropertyRepo):
...
class MetadefPropertyFactoryProxy(xmonitor.domain.proxy.MetadefPropertyFactory):
...
# Metadef Tag classes
class MetadefTagProxy(xmonitor.domain.proxy.MetadefTag):
...
class MetadefTagRepoProxy(xmonitor.domain.proxy.MetadefTagRepo):
...
class MetadefTagFactoryProxy(xmonitor.domain.proxy.MetadefTagFactory):
