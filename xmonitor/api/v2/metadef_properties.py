...
from xmonitor.api.v2 import metadef_namespaces as namespaces
...
from xmonitor.api.v2.model.metadef_property_type import PropertyTypes
...
def get_collection_schema():
    ...
    return xmonitor.schema.DictCollectionSchema('properties',
