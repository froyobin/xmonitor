...
API, its router was referenced in paste configuration as xmonitor.api.v3.router
In Mitaka the Artifacts Service was moved into a standalone process and its
router was renamed to xmonitor.api.artifacts.router.
However, in existing deployments the xmonitor-api-paste.ini may still reference
the xmonitor.api.v3.router. To not break these deployments this stub is included
    ...
    def __init__(self, mapper):
        versionutils.report_deprecated_feature(
            ...
            _LW('/v3 controller is deprecated and will be removed from '
                'xmonitor-api soon. Remove the reference to it from '
                'xmonitor-api-paste.ini configuration file and use Glance '
