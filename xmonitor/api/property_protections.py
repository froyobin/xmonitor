...
class ProtectedImageFactoryProxy(xmonitor.domain.proxy.ImageFactory):
...
class ProtectedImageRepoProxy(xmonitor.domain.proxy.Repo):
...
class ProtectedImageProxy(xmonitor.domain.proxy.Image):
...
class ExtraPropertiesProxy(xmonitor.domain.ExtraProperties):
