...
from xmonitor.domain import proxy as domain_proxy
...
_ALIASES = {
    'xmonitor.openstack.common.rpc.impl_kombu': 'rabbit',
    'xmonitor.openstack.common.rpc.impl_qpid': 'qpid',
    'xmonitor.openstack.common.rpc.impl_zmq': 'zmq',
}


def set_defaults(control_exchange='xmonitor'):
