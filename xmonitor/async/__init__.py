...
class TaskExecutor(object):
    ...
    Args:
        context: xmonitor.context.RequestContext object for AuthZ and AuthN
            checks
        task_repo: xmonitor.db.TaskRepo object which acts as a translator for
            xmonitor.domain.Task and xmonitor.domain.TaskStub objects
            into ORM semantics
        image_repo: xmonitor.db.ImageRepo object which acts as a translator for
            xmonitor.domain.Image object into ORM semantics
        image_factory: xmonitor.domain.ImageFactory object to be used for
