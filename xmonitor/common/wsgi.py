...
class Server(object):
    ...
    xmonitor store needs to be initialized.
    """
    def __init__(self, threads=1000, initialize_glance_store=False):
        ...
        try:
            ...
            # NOTE(flaper87): When running xmonitor-control,
            # (xmonitor's functional tests, for example)
            # setpgid fails with EPERM as xmonitor-control
            ...
            #
            # Running xmonitor-(api|registry) is safe and
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        langs = i18n.get_available_languages('xmonitor')
