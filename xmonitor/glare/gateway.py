...
import xmonitor.db
from xmonitor.glare import dependency
from xmonitor.glare import domain
from xmonitor.glare import location
from xmonitor.glare import updater
...
class Gateway(object):
    ...
    def get_artifact_repo(self, context):
        artifact_repo = xmonitor.db.ArtifactRepo(context,
                                                 self.db_api,
                                                 self.plugins)
