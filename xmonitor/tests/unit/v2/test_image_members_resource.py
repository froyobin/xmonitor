...
import xmonitor.api.v2.image_members
...
def _domain_fixture(id, **kwargs):
    ...
    return xmonitor.domain.ImageMembership(**properties)
...
class TestImageMembersSerializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.serializer = xmonitor.api.v2.image_members.ResponseSerializer()
        self.fixtures = [
...
class TestImagesDeserializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.deserializer = xmonitor.api.v2.image_members.RequestDeserializer()
