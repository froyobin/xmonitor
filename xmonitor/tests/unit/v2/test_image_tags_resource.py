...
import xmonitor.api.v2.image_tags
...
import xmonitor.tests.unit.v2.test_image_data_resource as image_data_tests
...
class TestImagesSerializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.serializer = xmonitor.api.v2.image_tags.ResponseSerializer()
