...
import xmonitor.api.v2.image_data
...
class TestImagesController(base.StoreClearingUnitTest):
    def setUp(self):
        ...
        self.controller = xmonitor.api.v2.image_data.ImageDataController(
    ...
    @mock.patch("xmonitor.common.trust_auth.TokenRefresher")
...
class TestImageDataDeserializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.deserializer = xmonitor.api.v2.image_data.RequestDeserializer()
...
class TestImageDataSerializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.serializer = xmonitor.api.v2.image_data.ResponseSerializer()
    ...
    def test_download_forbidden(self):
        ...
        self.stubs.Set(xmonitor.api.policy.ImageProxy,
                       'get_data',
                       get_data)
        request = wsgi.Request.blank('/')
        request.environ = {}
