...
import xmonitor.api.v2.image_actions
import xmonitor.api.v2.images
from xmonitor.common import exception
from xmonitor import domain
import xmonitor.schema
...
def _domain_fixture(id, **kwargs):
    ...
    return xmonitor.domain.Image(**properties)
...
class TestImagesController(base.IsolatedUnitTest):
    ...
    def setUp(self):
        ...
        self.controller = xmonitor.api.v2.images.ImagesController(self.db,
                                                                  self.policy,
                                                                  self.notifier,
                                                                  self.store)
        self.action_controller = (xmonitor.api.v2.image_actions.
...
class TestImagesDeserializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.deserializer = xmonitor.api.v2.images.RequestDeserializer()
...
class TestImagesDeserializerWithExtendedSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        schema = xmonitor.api.v2.images.get_schema(custom_image_properties)
        self.deserializer = xmonitor.api.v2.images.RequestDeserializer(schema)
...
class TestImagesSerializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.serializer = xmonitor.api.v2.images.ResponseSerializer()
        self.fixtures = [
...
class TestImagesSerializerWithExtendedSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        schema = xmonitor.api.v2.images.get_schema(custom_image_properties)
        self.serializer = xmonitor.api.v2.images.ResponseSerializer(schema)
...
class TestImagesSerializerWithAdditionalProperties(test_utils.BaseTestCase):
    ...
    def test_show(self):
        serializer = xmonitor.api.v2.images.ResponseSerializer()
        expected = {
            'id': UUID2,
            'name': 'image-2',
            'status': 'queued',
...
class TestImageSchemaFormatConfiguration(test_utils.BaseTestCase):
    def test_default_disk_formats(self):
        schema = xmonitor.api.v2.images.get_schema()
