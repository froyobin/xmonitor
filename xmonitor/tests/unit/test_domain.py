...
from xmonitor.async import taskflow_executor
...
from xmonitor.glare import domain as artifacts_domain
...
class TestTask(test_utils.BaseTestCase):
    ...
    @mock.patch.object(xmonitor.async.TaskExecutor, 'begin_processing')
    def test_run(self, mock_begin_processing):
        executor = xmonitor.async.TaskExecutor(context=mock.ANY,
                                               task_repo=mock.ANY,
                                               image_repo=mock.ANY,
