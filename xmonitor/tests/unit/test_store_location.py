...
CONF = {'default_store': 'file',
        ...
        'swift_store_container': 'xmonitor',
...
class TestStoreLocation(base.StoreClearingUnitTest):
    ...
    def test_add_location_for_image_without_size(self):
        ...
        with mock.patch('xmonitor.location._check_image_location'):
            ...
            locations = xmonitor.location.StoreLocations(image1, [])
            ...
            locations = xmonitor.location.StoreLocations(image2, [loc1])
            locations[0] = loc2
