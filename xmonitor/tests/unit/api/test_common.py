...
class TestSizeCheckedIter(testtools.TestCase):
    ...
    def test_uniform_chunk_size(self):
        ...
        checked_image = xmonitor.api.common.size_checked_iter(
    ...
    def test_too_few_chunks(self):
        resp = self._get_webob_response()
        meta = self._get_image_metadata()
        checked_image = xmonitor.api.common.size_checked_iter(resp, meta, 6,
                                                              ['AB', 'CD'],
                                                              None)
    ...
    def test_too_much_data(self):
        resp = self._get_webob_response()
        meta = self._get_image_metadata()
        checked_image = xmonitor.api.common.size_checked_iter(resp, meta, 3,
                                                              ['AB', 'CD'],
                                                              None)
