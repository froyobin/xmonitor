...
from xmonitor.cmd import cache_manage
from xmonitor.common import exception
import xmonitor.common.utils
import xmonitor.image_cache.client
...
class TestGlanceCmdManage(test_utils.BaseTestCase):
    ...
    @mock.patch.object(xmonitor.image_cache.client.CacheClient,
                       'get_cached_images')
    ...
    @mock.patch.object(xmonitor.cmd.cache_manage, 'user_confirm')
    @mock.patch.object(xmonitor.cmd.cache_manage, 'get_client')
    ...
    @mock.patch.object(xmonitor.cmd.cache_manage, 'lookup_command')
