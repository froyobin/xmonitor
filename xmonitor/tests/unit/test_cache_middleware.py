...
import xmonitor.api.middleware.cache
...
class TestCacheMiddlewareURLMatching(testtools.TestCase):
    def test_v1_no_match_detail(self):
        ...
        out = xmonitor.api.middleware.cache.CacheFilter._match_request(req)
...
class TestCacheMiddlewareRequestStashCacheInfo(testtools.TestCase):
    def setUp(self):
        ...
        self.middleware = xmonitor.api.middleware.cache.CacheFilter
...
class ChecksumTestCacheFilter(xmonitor.api.middleware.cache.CacheFilter):
    def __init__(self):
...
class ProcessRequestTestCacheFilter(xmonitor.api.middleware.cache.CacheFilter):
    def __init__(self):
