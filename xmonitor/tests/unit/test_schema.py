...
class TestBasicSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = xmonitor.schema.Schema('basic', properties)
...
class TestBasicSchemaLinks(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = xmonitor.schema.Schema('basic', properties, links)
...
class TestPermissiveSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = xmonitor.schema.PermissiveSchema('permissive', properties)
...
class TestCollectionSchema(test_utils.BaseTestCase):
    ...
    def test_raw_json_schema(self):
        ...
        item_schema = xmonitor.schema.Schema('mouse', item_properties)
        collection_schema = xmonitor.schema.CollectionSchema('mice', item_schema)
        expected = {
            'name': 'mice',
            'properties': {
                'mice': {
