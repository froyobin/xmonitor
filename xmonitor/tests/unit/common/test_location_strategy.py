...
from xmonitor.common.location_strategy import location_order
from xmonitor.common.location_strategy import store_type
from xmonitor.tests.unit import base


class TestLocationStrategy(base.IsolatedUnitTest):
    """Test routines in xmonitor.common.location_strategy"""
...
class TestLocationOrderStrategyModule(base.IsolatedUnitTest):
    """Test routines in xmonitor.common.location_strategy.location_order"""
...
class TestStoreTypeStrategyModule(base.IsolatedUnitTest):
    """Test routines in xmonitor.common.location_strategy.store_type"""
