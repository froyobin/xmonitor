...
from xmonitor.api.v1 import router as router_v1
from xmonitor.api.v2 import router as router_v2
from xmonitor.common import exception
from xmonitor.common import utils
from xmonitor.common import wsgi
from xmonitor import i18n
...
class RequestTest(test_utils.BaseTestCase):
    ...
    def _set_expected_languages(self, all_locales=None, avail_locales=None):
        ...
        def fake_gettext_find(lang_id, *args, **kwargs):
            found_ret = '/xmonitor/%s/LC_MESSAGES/xmonitor.mo' % lang_id
...
class GetSocketTestCase(test_utils.BaseTestCase):
    ...
    def test_correct_configure_socket(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'xmonitor.common.wsgi.ssl.wrap_socket',
            mock_socket))
        self.useFixture(fixtures.MonkeyPatch(
            'xmonitor.common.wsgi.eventlet.listen',
