...
from xmonitor.api.v1.images import Controller as acontroller
from xmonitor.common import client as test_client
...
from xmonitor.registry.api.v1.images import Controller as rcontroller
import xmonitor.registry.client.v1.api as rapi
from xmonitor.registry.client.v1.api import client as rclient
...
class TestRegistryV1Client(base.IsolatedUnitTest, test_utils.RegistryAPIMixIn):
    ...
    def setUp(self):
        ...
        self.FIXTURES = [
            ...
            self.get_fixture(id=UUID2, name='fake image #2', properties={},
                             size=19, location="file:///tmp/xmonitor-tests/2")]
    ...
    def test_add_image_with_properties(self):
        ...
        fixture = self.get_fixture(location="file:///tmp/xmonitor-tests/2",
    ...
    def test_add_image_with_location_data_with_encryption(self):
        ...
        location = "file:///tmp/xmonitor-tests/%d"
        loc_meta = {'key': 'value'}
