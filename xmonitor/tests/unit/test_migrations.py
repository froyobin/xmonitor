...
from xmonitor.db.sqlalchemy import migrate_repo
from xmonitor.db.sqlalchemy.migrate_repo.schema import from_migration_import
from xmonitor.db.sqlalchemy import models
from xmonitor.db.sqlalchemy import models_glare
from xmonitor.db.sqlalchemy import models_metadef
...
class MigrationsMixin(test_migrations.WalkVersionsMixin):
    ...
    def _pre_upgrade_019(self, engine):
        ...
        data = [
            {'id': 'fake-19-1', 'location': 'http://xmonitor.example.com'},
    ...
    def _check_019(self, engine, data):
        ...
        self.assertEqual('http://xmonitor.example.com',
