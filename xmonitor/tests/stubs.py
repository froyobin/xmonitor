...
from xmonitor.api.middleware import context
from xmonitor.api.v1 import router
import xmonitor.common.client
from xmonitor.registry.api import v1 as rserver
...
def stub_out_registry_and_store_server(stubs, base_dir, **kwargs):
    ...
    def fake_sendable(self, body):
        ...
        if force is None:
            ...
            if force:
                assert xmonitor.common.client.SENDFILE_SUPPORTED
            return force

    stubs.Set(xmonitor.common.client.BaseClient, 'get_connection_type',
              fake_get_connection_type)
    setattr(xmonitor.common.client.BaseClient, '_stub_orig_sendable',
            xmonitor.common.client.BaseClient._sendable)
    stubs.Set(xmonitor.common.client.BaseClient, '_sendable',
              fake_sendable)
