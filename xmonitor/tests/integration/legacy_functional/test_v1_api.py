...
from xmonitor.tests.integration.legacy_functional import base
...
class TestApi(base.ApiTest):
    ...
    def test_traceback_not_consumed(self):
        ...
        :see https://bugs.launchpad.net/xmonitor/+bug/755912
        """
    ...
    def _do_test_post_image_content_bad_format(self, format):
        ...
        :see https://bugs.launchpad.net/xmonitor/+bug/933702
        """
    ...
    def _do_test_put_image_content_missing_format(self, format):
        ...
        :see https://bugs.launchpad.net/xmonitor/+bug/937216
        """
