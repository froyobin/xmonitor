...
import xmonitor.common.client
from xmonitor.common import config
from xmonitor.db import migration
import xmonitor.db.sqlalchemy.api
import xmonitor.registry.client.v1.client
from xmonitor import tests as glance_tests
from xmonitor.tests import utils as test_utils


TESTING_API_PASTE_CONF = """
[pipeline:xmonitor-api]
...
[app:registryapp]
paste.app_factory = xmonitor.registry.api.v1:API.factory
...
class ApiTest(test_utils.BaseTestCase):
    ...
    def _connect_registry_client(self):
        ...
        self.stubs.Set(xmonitor.common.client.BaseClient,
