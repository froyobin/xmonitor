...
"""Functional test cases for xmonitor-manage"""
...
from xmonitor.tests.utils import depends_on_exe
...
class TestGlanceManage(functional.FunctionalTest):
    """Functional tests for xmonitor-manage"""

    def setUp(self):
        super(TestGlanceManage, self).setUp()
        conf_dir = os.path.join(self.test_dir, 'etc')
        utils.safe_mkdirs(conf_dir)
        self.conf_filepath = os.path.join(conf_dir, 'xmonitor-manage.conf')
