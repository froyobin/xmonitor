...
class TestImages(functional.FunctionalTest):
    ...
    def setUp(self):
        ...
        self.api_server.data_api = 'xmonitor.db.sqlalchemy.api'
        for i in range(3):
    ...
    def test_not_authenticated_in_registry_on_ops(self):
        ...
        # xmonitor-api and fails in xmonitor-registry if no token is passed
        self.api_server.deployment_flavor = ''
        # make sure that request will reach registry
        self.api_server.data_api = 'xmonitor.db.registry.api'
    ...
    def test_image_lifecycle(self):
        ...
        # The "changes-since" filter shouldn't work on xmonitor v2
...
class TestImagesWithRegistry(TestImages):
    def setUp(self):
        ...
        self.api_server.data_api = (
            'xmonitor.tests.functional.v2.registry_data_api')
