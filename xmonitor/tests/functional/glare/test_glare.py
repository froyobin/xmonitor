...
from xmonitor.api.glare.v0_1 import glare
from xmonitor.api.glare.v0_1 import router
from xmonitor.common.glare import definitions
from xmonitor.common.glare import loader
...
def _create_resource():
    ...
    with mock.patch(mock_this) as fep:
        path = 'xmonitor.tests.functional.glare.test_glare'
        fep.return_value = [
        ...
        plugins = loader.ArtifactsPluginLoader('xmonitor.artifacts.types')
...
class TestArtifacts(functional.FunctionalTest):
    ...
    def setUp(self):
        ...
        self.api_server.server_module = 'xmonitor.cmd.glare'
...
[app:apiversions]
paste.app_factory = xmonitor.api.glare.versions:create_resource

[app:glareapi]
paste.app_factory =
   xmonitor.tests.functional.glare.test_glare:TestRouter.factory

[filter:versionnegotiation]
paste.filter_factory =
 xmonitor.api.middleware.version_negotiation:
